...
<!-- Content Wrapper. Contains page content -->
	 ...
	 <tr>
		<td> <img src="{{ asset($item->slider_img) }}" style="width: 60px; height: 50px;">  </td>
		<td>
        @if($item->title== NULL)
		...
		<td width="30%">
 <a href="{{ route('slider.edit',$item->id) }}" class="btn btn-primary" title="Slider Details Data"><i class="fa fa-eye"></i> </a>

 <a href="{{ route('slider.edit',$item->id) }}" class="btn btn-info" title="Slider  Data"><i class="fa fa-pencil"></i> </a>
