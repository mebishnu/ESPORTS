...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
 ...
 <option value="{{ $category->id }}"{{ $category->id==$products->category_id ? 'selected':''}}>{{ $category->category_name_eng }}</option>	
			@endforeach
		</select>
		@error('category_id') 
	 <span class="text-danger">{{ $message }}</span>
 ...
 <option value="{{ $subcat->id }}"{{ $subcat->id==$products->subcategory_id? 'selected':''}}>{{ $subcat->subcategory_name_eng }}</option>	
			@endforeach
		</select>
...
<div class="row"> <!-- start 2nd row  -->
 ...
 <option value="{{ $subsubcat->id }}"{{ $subsubcat->id==$products->subsubcategory_id? 'selected':''}}>{{ $subsubcat->subsubcategory_name_eng }}</option>	
			@endforeach
		</select>
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Name Nepali <span class="text-danger">*</span></h5>
			<div class="controls">
				<input type="text" name="product_name_np" class="form-control"value="{{$products->product_name_np}}">
     @error('product_name_np') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			<h5>Product Tags Nepali <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_tags_np" class="form-control" value="{{$products->product_tags_np}}" data-role="tagsinput">
     @error('product_tags_np') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Product Size Nepali <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_size_np" class="form-control" value="{{$products->product_size_np}}" data-role="tagsinput">
     @error('product_size_np') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Product Color Nepali <span class="text-danger">*</span></h5>
			<div class="controls">
	 <input type="text" name="product_color_np" class="form-control" value="{{$products->product_color_np}}" data-role="tagsinput">
     @error('product_color_np') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_en" id="textarea" class="form-control" value="{{$products->short_descp_en}}" required placeholder="Textarea text">
	...
	{{$products->short_descp_en}}
	     ...
	     <div class="form-group">
			<h5>Short Description Nepali <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea name="short_descp_np" id="textarea" value="{{$products->short_descp_np}}" class="form-control" required placeholder="Textarea text">
	
	{{$products->short_descp_np}}
	</textarea>     
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80">
		{{$products->long_descp_en}}
	     ...
	     <div class="form-group">
			<h5>Long Description Nepali <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor2" name="long_descp_np" rows="10" cols="80">
	{{$products->long_descp_np}}
						</textarea>       
	 		 </div>
		</div>
