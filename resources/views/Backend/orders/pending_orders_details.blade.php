            ...
            <tr>
              <th>  </th>
               ...
               <a href="{{ route('pending-confirm',$order->id) }}" class="btn btn-block btn-success" id="confirm">Confirm Order</a>
                ...
                <a href="{{ route('processing-picked',$order->id) }}" class="btn btn-block btn-success" id="processing">Picked Order</a>
                @elseif ($order->status== 'processing')
                <a href="{{ route('picked',$order->id) }}" class="btn btn-block btn-success" id="processing">Picked Order</a>
