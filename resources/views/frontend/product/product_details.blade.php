...
<div class="description-container m-t-20">
	@if(session()->get('language') == 'nepali') {{ $product->short_descp_np}} @else {{ $product->short_descp_en }} @endif
	...
	<div class="quantity-container info-container">
		<div class="row">
			...
			<div class="col-sm-7">
                ...
                <!-- Go to www.addthis.com/dashboard to customize your tools -->
                <div class="addthis_inline_share_toolbox_t3e8"></div>
...
<div id="description" class="tab-pane in active">
	<div class="product-tab">
		<p class="text">@if(session()->get('language') == 'nepali') 
			{!! $product->long_descp_np !!} @else {!! $product->long_descp_en !!} @endif</p>
	</div>	
								</div><!-- /.tab-pane -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
				@if(session()->get('language') == 'nepali') {{ $product->product_name_np }} @else {{ $product->product_name_en }} @endif</a></h3>
			<div class="rating rateit-small"></div>
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-60d81fb159789378"></script>
