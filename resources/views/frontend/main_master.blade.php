...
<meta name="description" content="{{ $seco->meta_description }}">
<meta name="csrf-token" content="{{ csrf_token() }}">
<meta name="author" content="{{ $seco->meta_author }}">
...
<script type="text/javascript">
     function cart(){
        $.ajax({
          ...
          `<strong>${value.options.size} </strong>` 
            ...
            <td class="col-md-2">
                     <strong> <button type="submit" class="btn btn-success btn-sm"id="${value.rowId}" onclick="mycartDecreament(this.id)">- </button>
			<input type="text" value="${value.qty}" min="1" max="100" disabled="" style="width:25px;">
			<button type="submit" class="btn btn-danger btn-sm" id="${value.rowId}" onclick="mycartIncreament(this.id)">+</button></strong>
                    </td>    
                    <td class="col-md-2">
 ...
 /// MYCART INCREAMENT
 function mycartIncreament(rowId){
        $.ajax({
            type: 'GET',
...
////cart-decrement
function mycartDecreament(rowId){
        $.ajax({
            type: 'GET',
