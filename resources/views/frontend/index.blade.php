      ...
      <div class="row product-micro-row">
        ...
        <div class="col col-xs-7">
          <div class="product-info">
            <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">@if(session()->get('language') == 'nepali') {{ $product->product_name_np}} @else {{ $product->product_name_en }} @endif</a></h3>
            ...
            <div class="row">
              ...
              <div class="hidden-md col-sm-4 col-lg-4">
                <div class="info-box">
                  ...
                  <h6 class="text">Shipping on orders over Rs1000</h6>
                </div>
              </div>
              <!-- .col -->
              ...
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  ...
                  <h6 class="text">Extra Rs500 off on all items </h6>
                </div>
              </div>
              <!-- .col --> 
            </div>
...
@if(session()->get('language') == 'nepali') {{ $product->product_name_np }} @else {{ $product->	product_name_en }} @endif
            </a></h3>
          <div class="rating rateit-small"></div>
...
@if(session()->get('language') == 'nepali') {{ $product->product_name_np }} @else {{ $product->product_name_en }} @endif
 ...
 <!-- ============================================== SKIP CATEGORY 0 AND PRODUCTS  ============================================== -->
 <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
          
          @if(session()->get('language') == 'nepali') {{$skip_category_0->category_name_np}} @else {{$skip_category_0->category_name_eng}} @endif
...
@if(session()->get('language') == 'nepali') {{ $product->product_name_np }} @else {{ $product->product_name_en }} @endif
 ...
 <div class="product-price"> <span class="price"> Rs{{ $product->discount_price }} </span> <span class="price-before-discount">Rs {{ $product->selling_price }}</span> </div>
        ...
        <!-- ============================================== SKIP CATEGORY AND PRODUCTS : END ============================================== --> 




 <!-- ============================================== SKIP CATEGORY 1 AND PRODUCTS  ============================================== -->
 <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
          
          @if(session()->get('language') == 'nepali') {{$skip_category_1->category_name_np}} @else {{$skip_category_1->category_name_eng}} @endif
...
@if(session()->get('language') == 'nepali') {{ $product->product_name_np }} @else {{ $product->product_name_en }} @endif
 ...
 <section class="section featured-product wow fadeInUp">
          ...
          @if(session()->get('language') == 'nepali') {{$skip_brand_0->	brand_name_np}} @else {{$skip_brand_0->brand_name_eng}} @endif
